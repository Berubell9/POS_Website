...
export default function OrderCard() {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-5 text-gray-800">
            ...
            <div className="w-full">
                ...
                {/* Order Card */}
                <div className="min-h-30 p-4 mt-2 bg-white rounded-xl shadow-sm flex flex-col">
                    <p className='font-extrabold text-xl'>เลขออเดอร์</p>
                    <p className='text-gray-400 mt-1'>เลขโต๊ะ</p>
                    <div className='flex mt-2 items-center bg-gray-50 rounded-md p-4 '>
                        <img src='crepe.png' className='h-10'></img>
                        <p className='ml-2'>ชื่อเมนู</p>
                        <p className='ml-2 text-sm text-gray-800 px-2 py-1 bg-gray-200 rounded-2xl'>x2</p>
                    </div>
