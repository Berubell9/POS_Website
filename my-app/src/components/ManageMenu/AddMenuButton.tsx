    ...
    return (
        <div>
            ...
            <button
                ...
                className="flex bg-pink-400 text-white px-3 py-2 rounded-md shadow-md items-center"
            >
                <AddOutlinedIcon sx={{ fontSize: 20 }} className="mr-1" />
                เพิ่มเมนู
            </button>
                ...
                <div
                    ...
                    >
                        ...
                        <div className="flex items-center">
                            <PostAddOutlinedIcon />
                            <p className="ml-1 text-xl font-extrabold">เพิ่มเมนู</p>
                        </div>
